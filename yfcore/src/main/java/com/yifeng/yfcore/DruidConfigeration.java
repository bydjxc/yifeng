 ...
 * @Author: Kevin
 * @Description:<br>
 * @Date Created in 13:25 2019/3/18
 * @Modified By
 * @Version 1.0
 */
@Configuration
public class DruidConfigeration {
    ...
    public ServletRegistrationBean statViewServlet(){
        ...
        //设置控制台管理用户
        servletRegistrationBean.addInitParameter("loginUsername","lotus");
        servletRegistrationBean.addInitParameter("loginPassword","lotus");
        //是否可以重置数据
